...
<!-- tree --> 
<div id="sidetree"> 
<div class="treeheader">&nbsp;<strong>商品特定分类</strong>&nbsp;&nbsp;(<a href="special_classify.php" title="新增分类后，刷新后方能看到效果。">刷新分类</a>)</div>  	  
...
<ul id="tree">
	<?php 
		$sortarr = $db->get_results("SELECT * FROM ".DATATABLE."_order_classify where type=2 ORDER BY SiteID asc,id desc ");
...
<div id="sortright">
 ...
 <input type="hidden" name="types" id="types" value="2">
			...
			<fieldset title="“*”为必填项！" class="fieldsetstyle">
			<legend>修改特定分类（先点击左边相应的分类）</legend>
			<table width="92%" border="0" cellpadding="4" cellspacing="1" bgcolor="#FFFFFF" class="inputstyle">
                 <tr>
                  <td width="16%" bgcolor="#F0F0F0"><div align="right">上级分类：</div></td>
                  <td width="55%" bgcolor="#FFFFFF"><label>
