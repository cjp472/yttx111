        	    ...
        	    <label>
                  ...
                  <label>
                      <select id="date_field" name="date_field"  style="width:105px;" class="select2">
                          ...
                          <option value="to_date" <?php if($in['date_field'] == 'to_date') echo 'selected="selected"';?> >开票时间</option>
                      </select>
                  </label>
...
<?php
    ...
    $page->LinkAry = array("kw"=>$in['kw'],'date_field' => $in['date_field'] , 'bdate' => $in['bdate'], 'edate' => $in['edate']);
