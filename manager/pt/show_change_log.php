...
$sql = "select YEAR(FROM_UNIXTIME(ChangeTime)) as Ydate,MONTH(FROM_UNIXTIME(ChangeTime)) as Mdate,ChangeTime,ChangeUser,ChangeStatus,ChangeRunStatus,ChangeReason from ".DATABASEU.DATATABLE."_api_serial_changeinfo where CompanyID=".intval($in['ID'])." order by ID desc limit 0,1000";
...
<!--时间轴-->
    ...
    <div class="content1" >
                	...
                	<div class="mounth_info">
                        ...
                        <div class="mounth_right">
                        	<ul>
    							...
    							?>
    							<li>
                                	<h1><?php echo date("d 日 H:i",$dv['ChangeTime']);?><span class="chaozuo"> <?php echo $dv['ChangeUser'];?> </span> </h1>
                                    <p>
                                    
    								<?php echo nl2br($dv['ChangeReason']);?>
                                    </p>
		...
		<?php }
    		...
    		<dl >
    			<dt style="margin-top:10px;"><div class="years" style="width:200px;"><div class="clock"></div>暂无变更记录</dt>
    		<dl >
	   <?php } ?>
	</div>
</body>
