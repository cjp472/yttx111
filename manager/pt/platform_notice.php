    ...
    <div id="bodycontent">
    	...
    	<div id="searchline">
        	<div class="leftdiv">
        	  ...
        	  <form id="FormSearch" name="FormSearch" method="get" action="platform_notice.php">
				<label>&nbsp;&nbsp;添加日期：</label>
...
<?php
    ...
    $InfoDataNum = $db->get_row("SELECT count(*) AS allrow FROM ".DATATABLE."_pay_notice where type=2 ".$search_str);
	$page = new ShowPage;
    $page->PageSize = 10;
    $page->Total = $InfoDataNum['allrow'];
    $page->LinkAry = array("kw"=>$in['kw']);        
	$datasql  = "SELECT * FROM ".DATATABLE."_pay_notice where type=2 ".$search_str." order by addtime desc";
...
?>
          ...
          <form id="MainForm" name="MainForm" method="post" action="" target="exe_iframe" >
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
     			 <tr align="right">
       				 <td class="bottomlinebold"><input type="button" name="newbutton" id="newbutton" value=" 新增消息 " class="button_2" onclick="javascript:window.location.href='add_platform_notice.php'" />&nbsp;&nbsp;&nbsp;&nbsp;</td>
...
?>
	...
	?>
				   ...
				   <td> <?php echo date("Y-m-d H:i:s",$lsv['start_date']); ?></td>
				   <td><? echo date("Y-m-d H:i:s",$lsv['end_date']);?> </td>
                  <td align="right" title="<?php echo $lsv['CompanyRemark'];?>">

					<a href="edit_platform_notice.php?ID=<? echo $lsv['id'];?>" ><img src="img/icon_edit.gif" border="0" title="修改" class="img" /></a>&nbsp;&nbsp;
					<?php
	...
	<? } } }?>
			 ...
			 <tr>
				 ...
				 <td  align="right"><? echo $page->ShowLink('platform_notice.php');?></td>
			 </tr>
             </table>
