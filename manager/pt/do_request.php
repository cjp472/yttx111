...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td class="user_info_td1"><a href="http://tc.dhb.net.cn?c='.$rinfo['CompanyPrefix'].'&u='.$us.'&p='.$cinfo['ClientPassword'].'" target="_blank" style="text-decoration:none;" >http://tc.dhb.net.cn/'.$rinfo['CompanyPrefix'].'/</a></td>
  ...
  <tr>
    ...
    <td class="user_info_td1"><a href="http://3g.dhb.net.cn" target="_blank" style="text-decoration:none;">http://3g.dhb.net.cn</a></td>
    <td class="user_info_td1">'.$us.' </td>
    <td class="user_info_td1">'.$cinfo['ClientPassword'].' </td>
  </tr>
  <tr>
...
<div class="wechat_info">
	<div class="wechat_info_left">
    	<dt>微信公众帐号：订货宝手机体验端 </dt>
        <dt>微信号：www-dhb-hk</dt>
      <div class="ewm_text">扫描右侧二维码关注</div>
    </div>
	<div class="wechat_info_right">
    <img src="http://www.dhb.hk/email/images/ewm1.jpg" width="111" height="111" /> </div>
</div>
</div>
<!--微信客户端结束-->
<!--底部开始-->
...
<!--底部结束-->
		...
		if(!empty($cinfo['ClientMobile']) && is_phone($cinfo['ClientMobile'])){
			$message = "【订货宝】感谢您申请体验,您的体验帐号信息如下,订货端网址:tc.dhb.net.cn,帐号:".$us.",密码：".$cinfo['ClientPassword'].";管理端网址:tm.dhb.net.cn,帐号:".$uinfo['UserName'].",密码:".$rinfo['Password'].",微信订货端帐号：订货宝手机体验端.订货宝服务中心会在24小时内电话回访您,为您提供专业细致的服务支持。若有需要请致电客服中心4006311682.";
