...
<script src="js/manager.js?v=3<? echo VERID;?>" type="text/javascript"></script>
</head>
    ...
    <div id="bodycontent">
		...
		<div id="searchline">
        	<div class="leftdiv" style=" padding:4px 0 0 0;">
        	 <div style="width:150px; float:left;"><input name="addfinancelog" type="button" class="bluebtn" id="addfinancelog" value="添加收款记录" onclick="javascript:window.location.href='finance_log_add.php';" /></div>
			 <div style="width:200px; float:left;">
			 <form name="changetypeform" id="changetypeform" action="finance_log.php" method="get">
			 <select id="cid" name="cid" class="select2" onchange="javascript:submit()" >
			...
			<div class="rightdiv" style=" padding:4px 0 0 0;">短信通道余额:&nbsp;&nbsp;<a href="#" onclick="show_sms_number1();" title="系统通知">[1]</a>&nbsp;&nbsp;<a href="#" onclick="show_sms_number2();" title="系统群发">[2]</a>&nbsp;&nbsp;<a href="#" onclick="show_sms_number3();" title="校验码">[3]</a>&nbsp;&nbsp;</div>
        </div>
...
<?php
	...
	if(!empty($in['cid'])) $sqlmsg = " where PayCompany = ".intval($in['cid'])." "; else $sqlmsg = '';
	$InfoDataNum = $db->get_row("SELECT count(*) AS allrow FROM ".DATABASEU.DATATABLE."_order_pay ".$sqlmsg);
	$page = new ShowPage;
    $page->PageSize = 50;
    $page->Total = $InfoDataNum['allrow'];        
	
	$datasql   = "SELECT * FROM ".DATABASEU.DATATABLE."_order_pay ".$sqlmsg." Order by PayID Desc";
