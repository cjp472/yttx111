...
$sqlUserLogin = " select count(*) as allrow,b.CompanyIndustry,b.IsUse from ".DATABASEU.DATATABLE."_order_login_user_log a
...
<div id="bodycontent">
    ...
    <div id="searchline">
        <table width="98%" border="0" cellspacing="0" cellpadding="0" align="center" >
            <form id="FormSearch" name="FormSearch" method="post" action="ty_analyze.php">
                <tr>
                    ...
                    <td aling="right"><div class="location"><strong>当前位置：</strong><a href="manager.php">客户管理</a> &#8250;&#8250; <a href="ty_analyze.php">体验数据分析-管理端</a></div></td>
                </tr>
            </form>
        </table>
    </div>
    ...
    <div class="warning">
        注：基于后台管理员登录日志分析行业使用情况。【<a href="ty_analyze_client.php" style="color:#277db7;">查看订货端</a>】
    </div>
