...
<div id="bodycontent">
    ...
    <div id="searchline">
        <table width="98%" border="0" cellspacing="0" cellpadding="0" align="center" >
            <form id="FormSearch" name="FormSearch" method="post" action="ty_analyze_client.php">
                <tr>
                    ...
                    <td aling="right"><div class="location"><strong>当前位置：</strong><a href="manager.php">客户管理</a> &#8250;&#8250; <a href="ty_analyze_client.php">体验数据分析-管理端</a></div></td>
                </tr>
            </form>
        </table>
    </div>
    ...
    <div class="warning">
        注：基于订货端经销商登录日志分析行业使用情况。【<a href="ty_analyze.php" style="color:#277db7;">查看管理端</a>】
    </div>
