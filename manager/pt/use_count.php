    ...
    <div id="bodycontent">
    	...
    	<div id="searchline">
        	...
        	<div class="leftdiv">
        	  ...
        	  <form id="FormSearch" name="FormSearch" method="get" action="use_count.php">
				...
				<select id="companytype" name="companytype"  style="width:105px;" class="select2">
				  <option value="" >⊙ 全部客户</option>
          <option value="T" >⊙ 活跃客户</option>
        ...
        <?php    
          ...
          $sqlmsg .= " and s.IsCharge = 'T'";

          if($in['companytype'] == 'T'){
            $sqlmsg .= " and v.order_30 > 10 ";
          }
        	...
        	$page->LinkAry = array("kw"=>$in['kw'],"iid"=>$in['iid'],"aid"=>$in['aid'],"gid"=>$in['gid'],"date_field"=>$in['date_field'],"bdate"=>$in['bdate'],"edate"=>$in['edate'],"companytype"=>$in['companytype']);
        ...
        ?>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td  align="right"><? echo $page->ShowLink('use_count.php');?></td>
                    </tr>
                 </table>
			  <table width="100%" border="0" cellspacing="0" cellpadding="0">
               <thead>
