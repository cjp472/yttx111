        ...
        <div class="bline">
            <?php
            	...
            	if(empty($in['num'])){
            		...
            		if(!empty($in['flagval']) && ($in['flagval'] != 'ALL')) $sqlmsg .= " and s.SaleFlag = '{$in['flagval']}' ";
            		if(empty($in['flagval'])) $sqlmsg .= " and s.SaleFlag = 'T' ";
            	...
            	$datasql   = "SELECT s.*,u.UserTrueName FROM ".DATABASEU.DATATABLE."_order_sale as s left join ".DATABASEU.DATATABLE."_order_user as u ON s.UpdateUID = u.UserID where s.ID > 0 ".$sqlmsg."  ORDER BY s.ID DESC";
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">               
                    <thead>
                        <tr>
                          ...
                          <td width="10%" class="bottomlinebold">电话</td>
...
<!--                                        <td >-->
<!--                                            --><?// echo $lsv['saleUrl'];?>
<!--                                            <a target="_blank" href="createWeixin.php?text=--><?// echo $lsv['saleUrl'];?><!--&size=400&date=--><?// echo random(10);?><!--">[二维码]</a>-->
<!--                                        </td>-->
                                        <td ><? echo $lsv['UserTrueName'];?></td>
                                        <td ><? echo date("Y-m-d H:i",$lsv['UpdateDate']);?></td>                                    
                                        <td >
                                            <a target="_blank" href="sale_url.php?saleId=<? echo $lsv['ID'];?>&name=<? echo $lsv['SaleName'];?>">[个性化地址]</a>
                                            &nbsp;&nbsp;
                                            <? echo "<a class='showSale' href='javascript:;' data-sid='".$lsv['ID']."' data-name='".$lsv['SaleName']."' data-dept='".$lsv['SaleDepartment']."' data-phone='".$lsv['SalePhone']."' data-flag='".$lsv['SaleFlag']."' data-remark='".$lsv['Remark']."'>[编辑]</a>";?>                                            
                                            &nbsp;&nbsp;
            ...
            <form id="open_sale_fm">
                ...
                <table width="100%">
                    ...
                    <tr class="bottomline">
                        ...
                        <td align="left">
                            <select style="width:60%" name="SaleFlag">
