...
<?php
	...
	$InfoDataNum = $db->get_row("SELECT count(*) AS allrow FROM ".DATABASEU.DATATABLE."_buy_sms where type = 'valid' ".$sqlmsg." ");
	$page = new ShowPage;
    $page->PageSize = 50;
    $page->Total = $InfoDataNum['allrow'];
    $page->LinkAry = array("kw"=>$in['kw']);        
	
	$datasql   = "SELECT * FROM ".DATABASEU.DATATABLE."_buy_sms  where type = 'valid' ".$sqlmsg." ORDER BY id DESC";
