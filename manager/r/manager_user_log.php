...
<?php include_once ("inc/son_menu_bar.php");?>
 ...
 <div id="bodycontent">
    	...
    	<div id="searchline">
        	<div class="leftdiv">
        	  <form id="FormSearch" name="FormSearch" method="post" action="manager_user_log.php">
			...
			<div class="location"><strong>当前位置：</strong><a href="manager_user_log.php">登陆日志-管理员</a> </div>
        </div>
...
<strong>客户</strong></div>  	  
				<form name="changetypeform" id="changetypeform" action="manager_user_log.php" method="get">
...
<? }?>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
     			 <tr>
       			     ...
       			     <td  align="right"><? echo $page->ShowLink('manager_user_log.php');?></td>
     			 </tr>
              </table>
