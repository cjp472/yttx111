        ...
        <div class="bline" >
            ...
            <table width="98%" border="0" cellpadding="4" cellspacing="1" bgcolor="#FFFFFF"  class="inputstyle">                                
                <tr>
                  ...
                  <td width="55%"><label>
                  <select name="data_CompanyID" id="data_CompanyID"  style="line-height:30px;" class="select2">
                    <option value="0">⊙ 请选择试用帐号</option>
                    <?
					$letter  = new letter();					
					$datasql   = "SELECT c.CompanyID,c.CompanySigned,s.CS_EndDate FROM ".DATABASEU.DATATABLE."_order_company c left join ".DATABASEU.DATATABLE."_order_cs s on c.CompanyID=s.CS_Company where CompanyIndustry<>15 and CompanyIndustry<>16 and c.CompanyFlag='0' ".$sqlmsg."  ORDER BY c.CompanyIndustry asc,c.CompanyID ASC";
