...
<?php include_once ("inc/son_menu_bar.php");?>
 ...
 <div id="bodycontent">
    	...
    	<div id="searchline">
        	<div class="leftdiv">
        	  <form id="FormSearch" name="FormSearch" method="post" action="manager_client_log.php">
...
<strong>客户</strong></div>  	  
				...
				<form name="changetypeform" id="changetypeform" action="manager_client_log.php" method="get">
...
<?
    ...
    $page->LinkAry = array("kw"=>$in['kw'],"t"=>$in['t'],"cid"=>$in['cid']);        
        	  ...
        	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
               <thead>
                <tr>
                  ...
                  <td width="24%" class="bottomlinebold">帐号</td>
