...
$sqlUserLogin = " select count(*) as allrow,b.CompanyIndustry from ".DATABASEU.DATATABLE."_order_login_user_log a
...
<?php include_once ("inc/son_menu_bar.php");?>
    ...
    <div id="bodycontent">
        ...
        <div class="warning">
			注：基于后台管理员登录日志分析行业使用情况。【<a href="experience_analyze_client.php" style="color:#277db7;">查看订货端</a>】
		</div>
