...
<?php include_once ("inc/son_menu_bar.php");?>
    ...
    <div id="bodycontent">
		...
		<div id="searchline">
        	<div class="leftdiv">
        	 <div class="locationl"><a name="editname"></a><strong>当前位置：</strong><a href="manager.php">客户管理</a> &#8250;&#8250;<a href="experience.php">体验入口</a>&#8250;&#8250; <a href="industry.php">行业管理</a> </div>
          </div>
        ...
        <div class="bline" >
       	  ...
       	  <div class="linebutton">
       	  	<input type="button" onclick="javascript:window.location.href='experience_industry_option.php'" class="button_2" value=" 配置行业 " id="newbutton" name="newbutton">
       	  	<input type="button" onclick="javascript:window.location.href='experience_company.php'" value="创建公司" id="savedelid" class="button_3" name="savedelid">
       	  </div>
       	  <hr/>
