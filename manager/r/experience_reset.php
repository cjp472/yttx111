...
<?php include_once ("inc/son_menu_bar.php");?>
    ...
    <div id="bodycontent">
		...
		<div id="searchline">
        	<div class="leftdiv">
        	 <div class="locationl"><a name="editname"></a><strong>当前位置：</strong><a href="manager.php">客户管理</a> &#8250;&#8250; <a href="experience.php">体验入口</a>&#8250;&#8250;<a href="experience.php">体验入口</a>&#8250;&#8250; <a href="experience_reset.php">还原体验数据</a></div>
          </div>
...
<div id="sortleft">
 ...
 <form id="MainForm" name="MainForm" method="post" target=""  action="">
             <table width="100%" cellspacing="0" cellpadding="0" border="0">
               <thead>
                <tr>
                  ...
                  <td width="50px" class="bottomlinebold">忽略</td>
                </tr>
     		 </thead>      		
      		<tbody>
		      	<?php 
				...
				<tr onmouseout="outStyle(this)" onmouseover="inStyle(this)" class="bottomline" industry="<?php echo $in['industry'];?>" id="line_<?php echo $in['industry'];?>" style="">
                  <td colspan="2"><?php echo $sortarr[$in['industry']]['IndustryName'];?></td>
                </tr>
				<?php else:?>
               ...
               <tr onmouseout="outStyle(this)" onmouseover="inStyle(this)" class="bottomline" industry="<?php echo $svar['IndustryID'];?>" id="line_<?php echo $svar['IndustryID'];?>" style="">
                  ...
                  <td><a style="width:30px;color:red;font-size:14px;cursor:pointer;" onclick="deleteItemHy('<?php echo $svar['IndustryID'];?>');">[x]</a></td>
                </tr>
                <?php endforeach; ?>
				<?php endif;?>
 				</tbody>                
            ...
            <div style="padding-right:10px;margin-top:80px;">
				<input id="clear_industry_button" type="button" class="button_1" id="make_company_button" value="开始还原" onclick="do_clear_industry();" />
			</div>
              <INPUT TYPE="hidden" name="referer" value ="" >
      </form>
       	  </div>
<div id="sortright">
	<div style="font-size:25px;color:#999;margin-bottom:10px;">还原进度消息框</div>
