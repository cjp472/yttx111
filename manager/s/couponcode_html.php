...
function modifyMobile(){ 
	...
	if(!$('#modify-mobile').val()){ 
		...
		$.post("order.php?m=edit_mobile_save&mobile="+$('#modify-mobile').val(),
			function(data){
				data = $.trim(data);
					if(data=="ok")
					{
...
#couponcode-box { 
	...
	#couponcode-box .couponcode-submit { 
		...
		#couponcode-box .couponcode-submit input[type="text"]{ border:1px solid #cacaca;padding:3px 4px;width:90px;
		}

		#couponcode-box .couponcode-submit input[type="button"]{ border:1px solid #f11c54;padding:2px 6px;background:#f11c54;color:#FFF;
			height:28px;line-height:18px;
		}
			#couponcode-box .couponcode-submit input[type="button"]:hover{ background:#d5093f;
			}
...
<div id="couponcode-box" <?php if($sessionCode):?>style="display:none;"<?php endif;?>>
	<div class="couponcode-content">
		<div class="couponcode-title">分享我的优惠码 <span class="couponcode-special"><?php echo $codedata['Code'];?></span> 邀请朋友使用订货宝，即可获得 <span class="couponcode-special">20%现金</span> 反馈，购买者可获 <span class="couponcode-special">八折优惠</span>！惠人又利己，快来参与吧！
		</div>
...
<div id="couponcode-box-mini" <?php if(!$sessionCode):?>style="display:none;"<?php endif;?>>
	<div class="couponcode-title">分享我的优惠码 <span class="couponcode-special"><?php echo $codedata['Code'];?></span> 邀请朋友使用订货宝，即可获得 <span class="couponcode-special">20%现金</span> 反馈，购买者可获 <span class="couponcode-special">八折优惠</span>！惠人又利己，快来参与吧！&nbsp;&nbsp;<a href="javascript:void(0);" onclick="openCoupon();" class="couponcode-special">[展开查看详情]</a>
	</div>
</div>