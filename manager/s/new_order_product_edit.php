...
if(!intval($in['ID']))
{
	...
	$oinfo = $db->get_row("SELECT OrderID,OrderSN,OrderUserID,OrderStatus,OrderTotal FROM ".DATATABLE."_order_orderinfo where OrderCompany = ".$_SESSION['uinfo']['ucompany']." and OrderID=".intval($in['ID'])." limit 0,1");
}
  ...
  <tr>
   ...
   <tbody>
	...
	<td align="center"><? echo $cvar['Units'];?></td>
        <td align="center"><?php echo $cvar['Casing']; ?></td>
