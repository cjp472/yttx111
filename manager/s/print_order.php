...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" >
  ...
  <tr>
   ...
   <?php 
	...
	$bottommsg = '  <tr>
    <td colspan="'.(count($tdfield)).'" ><strong>收货人：</strong>'.$oinfo['OrderReceiveName'].'&nbsp;&nbsp;&nbsp;&nbsp;<strong>电话：</strong>'.$oinfo['OrderReceivePhone'].'&nbsp;&nbsp;&nbsp;&nbsp;<strong>交货日期：</strong>'.$oinfo['DeliveryDate'].'&nbsp;&nbsp;&nbsp;&nbsp;<strong>地址：</strong>'.$oinfo['OrderReceiveAdd'].'</td>
  </tr>
  <tr>
