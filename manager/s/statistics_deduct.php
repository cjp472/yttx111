...
<div class="bodyline" style="height:25px;"></div>
    ...
    <div id="bodycontent">
    	...
    	<div id="searchline">
			...
			<div class="location"><strong>当前位置：</strong> <a href="statistics_deduct.php">业务员提成统计</a></div>           
        </div>
		...
		<script type="text/javascript">		
			...
			$(document).ready(function() {
			 ...
			 <tr class="bottomline" onmouseover="inStyle(this)"  onmouseout="outStyle(this)">
                  <td>&nbsp;<? echo $n++;?></td>
				  <td ><a href="client_content.php?ID=<? echo $var['ClientID'];?>" target="_blank" ><? echo $clientarr[$var['ClientID']];?></a></td>	
