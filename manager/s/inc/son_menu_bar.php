...
<div class="bodyline" style="height:32px;">
	<div class="leftdiv" style=" margin-top:8px; padding-left:12px;">
		...
		<span valign="bottom">&nbsp;&nbsp;<? echo $_SESSION['uinfo']['usertruename']."(".$_SESSION['uinfo']['username'].")";?> 欢迎您！</span>
        &nbsp;&nbsp;<span style="display:none;" >[<a href="<?php echo HELP_URL;?>" target="_blank"><font color=red>帮助？</font></a>]</span>
...
//                     if(in_array($cs_info['CS_Flag'],array('W','F',''))) {
//                         continue;
//                     }
//                 }
