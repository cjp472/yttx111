...
if($verify_result) {//验证成功
    ...
    if($_GET['trade_status'] == 'TRADE_FINISHED' || $_GET['trade_status'] == 'TRADE_SUCCESS') {
		//判断该笔订单是否在商户网站中已经做过处理（可参考“集成教程”中“3.4返回数据处理”）
			...
			//如果有做过处理，不执行商户的业务程序
		$db->query("update ".DATATABLE."_order_pay set PayMoney='".$total_fee."',PayTradeNO='".$_GET['trade_no']."',PayBuyer='".$_GET['buyer_email']."',PayStatus='".$_GET['trade_status']."' where PayCompany = ".$_SESSION['uinfo']['ucompany']." and PaySN = '".$dingdan."' limit 1");

			$message = '支付宝'.$_GET['buyer_email'].' 充值: '.$total_fee.'元 单号:'.$dingdan.'状态:'.$_GET['trade_status'].' [订货宝]';
    ...
    else
	{
		echo "trade_status=".$_GET['trade_status'];
	  	$db->query("update ".DATATABLE."_order_pay set PayTradeNO='".$_GET['trade_no']."',PayBuyer='".$_GET['buyer_email']."',PayStatus='".$_GET['trade_status']."' where PayCompany = ".$_SESSION['uinfo']['ucompany']." and PaySN = '".$dingdan."' limit 1");
    }
...
?>
    ...
    <body>
        ...
        <table align="center" width="650" cellpadding="5" cellspacing="0">
            <tr>
                <td align="center" class="font_title" colspan="2">返回通知</td>
            </tr>
            <tr>
