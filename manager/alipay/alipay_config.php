...
$partner		= "2088602145037585";

//安全检验码，以数字和字母组成的32位字符
$key   			= "8iy4t802jsltw8zhr8wbmfsdn0rfixeh";

//签约支付宝账号或卖家支付宝帐户
$seller_email	= "pay@rsung.com";

//交易过程中服务器通知的页面 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
$notify_url		= "http://m.dhb.hk/alipay/notify_url.php";

//付完款后跳转的页面 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
//return_url的域名不能写成http://localhost/js_php_utf8/return_url.php ，否则会导致return_url执行无效
$return_url		= "http://m.dhb.hk/alipay/return_url.php";

//网站商品的展示地址，不允许加?id=123这类自定义参数
$show_url		= "http://m.dhb.hk/m/system.php";
