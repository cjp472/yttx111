<?php
	...
	$f	= new upfile();
	$f->makeThumb($_FILES['Filedata']['tmp_name'], $srcpath."thumb_".$sFileName,140,120);
	@chmod($srcpath."thumb_".$sFileName, 0777);
	$f->makeThumb($_FILES['Filedata']['tmp_name'], $srcpath."img_".$sFileName,680,6000);
	...
	$filearr['realpath']   = RESOURCE_URL.str_replace(RESOURCE_PATH,'',$srcpath."thumb_".$sFileName);
