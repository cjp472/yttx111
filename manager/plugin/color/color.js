		...
		do{			
			if(subDiv.tagName=='DIV' && subDiv.className!='colorPickerCloseButton'){
				if(subDiv==this){
					...
					img.src = img_path + "images/tab_right_active.gif"
					...
					img.src = img_path + "images/tab_right_inactive.gif"
					self.status = img.src;
	...
	function createColorPickerTopRow(inputObj){
		...
		for(var no=0;no<tabs.length;no++){			
			...
			tabImg.src = img_path + "images/tab_right_" + suffix + ".gif";
