    ...
    <div id="bodycontent">
		...
		<div id="searchline">
        	<div class="leftdiv width300">
        	 <div class="locationl"><strong>当前位置：</strong><a href="system.php">系统设置</a> &#8250;&#8250; <a href="accounts.php">收款账户</a>  &#8250;&#8250; <a href="accounts_add.php">新增帐户</a></div>
   	        </div>
            
            <div class="rightdiv sublink" style="padding-right:20px;">
			<input name="saveclientid" type="button" class="button_1" id="saveclientid" value="保 存" onclick="do_save_accounts();" />
...
<ul>
	...
	<li> <a href="client_level.php">经销商级别设置</a></li>
              ...
              <table width="98%" border="0" cellpadding="4" cellspacing="1" bgcolor="#FFFFFF" class="inputstyle">
                 <tr>
                  ...
                  <td width="55%" bgcolor="#FFFFFF"><label><span class="red">
                     <input type="text" name="data_AccountsBank" id="data_AccountsBank"  />
                  *</span></label></td>
                ...
                <tr>
                  ...
                  <td width="55%" bgcolor="#FFFFFF"><label>
                    <input type="text" name="data_AccountsNO" id="data_AccountsNO" value=""    />
                  <span class="red">*</span></label></td>
                  <td width="29%" bgcolor="#FFFFFF">卡号、存折号、支付宝账号</td>
                </tr>
                <tr>
                  <td bgcolor="#F0F0F0"><div align="right">开户名称(收款人)：</div></td>
                  <td bgcolor="#FFFFFF"><input type="text" name="data_AccountsName" id="data_AccountsName"  />
                ...
                <tr>
                  ...
                  <tr>
                      ...
                      <td bgcolor="#FFFFFF">
                          <label>
                              <input type="radio" name="data_PayType" id="data_PayType1" value="transfer" checked="checked"  style="border:0; width:15px; height:15px; VERTICAL-ALIGN: middle;" onclick="selectpayclick();"  /><strong>&nbsp;客户转帐</strong>
                          </label>
                          <label>
                  ...
                  <tr id="show_alipay_id" style="display:none;">
                      <td bgcolor="#F0F0F0"><div align="right">支付宝签约信息：</div></td>
                      <td bgcolor="#FFFFFF">
                      <div style="margin:4px 0;"><strong>是否开通移动支付: </strong><br /><span ><input type="radio" name="data_AliPhone" id="data_AliPhone1" value="F" checked="checked" style="border:0; width:15px; height:15px; VERTICAL-ALIGN: middle;"   />&nbsp;未开通</span>&nbsp;&nbsp;<span>
					<input type="radio" name="data_AliPhone" id="data_AliPhone2" value="T"  style="border:0; width:15px; height:15px; VERTICAL-ALIGN: middle;"  />&nbsp;开通（请先与支付宝开通移动支付服务）</span></div>
