...
<div ><strong><a href="deduct.php">所有客情官</a></strong></div>
<ul>
	<form name="changetypeform" id="changetypeform" action="deduct.php" method="get">
		<select id="sid" name="sid" onchange="javascript:submit()" style="width:85%;" class="select2">
        	  ...
        	  <table width="100%" border="0" cellspacing="0" cellpadding="2">
               <thead>
                <tr>
				  ...
				  <td width="16%" class="bottomlinebold">客情官</td>
                  <td width="16%" class="bottomlinebold" >订单号</td>
				  <td width="8%" class="bottomlinebold" align="right" >提成金额</td>
                  <td width="18%" class="bottomlinebold" align="center">发放状态/时间</td>
                  <td width="6%" class="bottomlinebold" align="center">明细</td>
                </tr>
     		 </thead>      		
      		<tbody>
<?
...
?>
                <tr id="line_<? echo $lsv['DeductID'];?>" class="bottomline" onmouseover="inStyle(this)"  onmouseout="outStyle(this)" >
				  ...
				  <? }?></td> 				  
                  <td align="center">
					<a href="javascript:void(0)" onclick="show_deduct(<? echo $lsv['DeductID'];?>);" >明细</a>
				  </td>
                </tr>
<? } }else{?>
     			 <tr>
