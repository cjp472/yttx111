...
<head>
    ...
    <script src="js/system.js?v=20150831" type="text/javascript"></script>
        <style>
            ...
            .dateInfo thead tr td {
                border-bottom:  2px solid #CCCCCC;
                font-weight: bold;
                color: black;
                font-size: 13px;
            }
            .dateInfo tbody tr td {
                border-bottom: 1px dashed gray;
                height: 50px;
            }
            .dateInfo tbody tr td span{
                font-size: 13px;
                color: black;
            }
            .permissionAgencyNum,.sortNum{
                font-weight: bold;
            }
    </style>
</head>
...
<div id="topmenu">
    <div id="header2">
        ...
        <ul>
            <li ><a href="">反馈</a></li><li class="current"><a href="">使用</a></li><li><a href="">体验</a></li>
        </ul>
    </div>
</div>
...
<div class="right-slide clearfix">
    <div class="slide-left">
        ...
        <ul class="slide-bottom slide-ul clearfix" style="margin-left:0px;margin-top:0px;position:absolute;bottom:0;padding-left:0px;" id="move-bar-in-li">
            ...
            <li style="display:none;" class="slide-help" onclick="window.open('http://help.dhb.net.cn/manager.php','_blank');" style="cursor: pointer;">
...
<div class="bodyline" style="height:32px;">
    ...
    <div class="rightdiv">
        <span class="leftdiv"><img src="img/menu2_left.jpg" /></span>
            <span id="menu2">
			<ul>
               <li ><a href="">客户数据</a></li> <li ><a href=""   class ="current2">基本数据</a></li><li ><a href="">活跃情况</a></li></ul>
		</span>
    ...
    <div id="searchline">
        <div class="leftdiv">
            <form id="FormSearch" name="FormSearch" method="post" action="">
                <label>
                    &nbsp;&nbsp;搜索： <input type="text"  class="searchText" />
                </label>
                <!--行业-->
                <label>
                    <select class="allIndustry" style="width: 120px;">
                        <option value="">所有行业</option>
                    </select>
                </label>
                <!--地区-->
                <select class="allArea" style="width: 120px;">
                    <option value="">所有地区</option>
                </select>
                <!--到期时间-->
                <select class="expireTime" style="width: 120px;">
    ...
    <div class="bline">
        <div >
            <form id="MainForm" name="MainForm" method="post" action="" target="exe_iframe" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="dateInfo">
                    <thead>
                    <tr>
                        <td  class="bottomlinebold">编号</td>
                        <td  class="bottomlinebold">公司名称/系统名称</td>
                        <td  class="bottomlinebold">品类</td>
                        <td  class="bottomlinebold">商品</td>
                        <td  class="bottomlinebold" >药店</td>
                        <td  class="bottomlinebold" >许可药店</td>
                        <td  class="bottomlinebold">管理员</td>
                        <td class="bottomlinebold">短信数</td>
                        <td class="bottomlinebold">开通/到期时间</td>
                    </tr>
                    </thead>
                    <tbody>
                        <tr class="detailInfo">
                            <td ><span class="Num">162</span></td>
                            <td><span class="companyName">成都阿商</span></td>
                            <td><span class="typeNum">1</span></td>
                            <td><span class="goodsNum">0</span></td>
                            <td><span class="agencyNum">3</span></td>
                            <td><span class="permissionAgencyNum">50</span></td>
                            <td><span class="AdministratorNum">2</span></td>
                            <td><span class="sortNum">2000</span></td>
                            <td><span class="time">2015-12-01-2015-1-1</span></td>
                        </tr>
                    </tbody>
