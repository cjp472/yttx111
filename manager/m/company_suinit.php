                            ...
                            <fieldset  class="fieldsetstyle">
                                ...
                                <table width="98%" border="0" cellpadding="4" cellspacing="1" bgcolor="#FFFFFF" class="inputstyle">
                                    <tr>
                                      ...
                                      <td bgcolor="#FFFFFF">&nbsp;<input name="data_UserName" type="text" id="data_UserName"  maxlength="18" /><span class="red">*</span></td>
                                        <td bgcolor="#FFFFFF">可以是数字、字母、下划线(3-18位)</td>
                                    </tr>
                                    <tr>
                                      <td bgcolor="#F0F0F0"><div align="right">密码：</div></td>
                                      <td bgcolor="#FFFFFF">&nbsp;<input name="data_NewPass" type="password" id="data_NewPass" value=""  maxlength="18" />
                                      <span class="red">*</span></td>
                                      <td bgcolor="#FFFFFF">&nbsp;</td>
                                    </tr>
                                    <tr>
                                      <td bgcolor="#F0F0F0"><div align="right">确认密码：</div></td>
                                      <td bgcolor="#FFFFFF">&nbsp;<input name="data_ConfirmPass" type="password" id="data_ConfirmPass" value=""  maxlength="18" />
                                      <span class="red">*</span></td>
                                      <td bgcolor="#FFFFFF">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td bgcolor="#FFFFFF">http://
                                            <input type="text" style="width:50px;margin-top:-3px;" name="data_CompanyPrefix" id="data_CompanyPrefix" value=""/> .dhb.hk
                                            <span class="red">*</span></td>
                                    ...
                                    <tr>
                                        ...
                                        <td width="55%" bgcolor="#FFFFFF"><label>
                                                ...
                                                <input type="hidden" name="companytype" id="companytype" value="<? echo $cinfo['CompanyType'];?>" />
                                    ...
                                    <tr>
                                        ...
                                        <td bgcolor="#FFFFFF">
                                                <input type="text" name="data_CompanyMobile" id="data_CompanyMobile" value="<? echo $cinfo['CompanyMobile'];?>"/>
                                                <span class="red">*</span></td>
                                        </td>
                ...
                <script type="text/javascript">
                    function do_edit_company()
                    {
                        ...
                        else if($('#data_CompanyIndustry').val()=="" || $('#data_CompanyIndustry').val()=="0")
                        {
                            ...
                            $.post("do_system.php?m=content_edit_suningmerchant_save",$("#MainForm").serialize(),
                                function(data){
                                    data = $.trim(data);
                                    if(data == "ok"){
