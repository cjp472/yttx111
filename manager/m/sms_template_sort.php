    ...
    <div id="bodycontent">
		...
		<div id="searchline">
        	...
        	<div class="leftdiv">
        	 ...
        	 <div class="location"><a name="editname"></a><strong>&nbsp;&nbsp; 当前位置：</strong><a href="sms.php">短信</a>  &#8250;&#8250; <a href="sms_template.php">短信模板</a> </div>
...
<strong><img src="css/images/home.gif" alt="分类"  />&nbsp;&nbsp;模板分类</strong></div>
...
<ul>
...

	{
		...
		echo '<li>'.($i+1).'、<a href="#editname" onclick="set_edit_template_sort(\''.$sinfo[$i]['SortID'].'\',\''.$sinfo[$i]['SortName'].'\',\''.$sinfo[$i]['SortOrder'].'\');">'.$sinfo[$i]['SortName'].'</a></li>';
...
<div id="sortright">
 ...
 <form id="MainForm" name="MainForm" enctype="multipart/form-data" method="post" target=""  action="">
		...
		<legend>新增分类</legend>
			...
			<input name="saveclientid" type="button" class="button_1" id="saveclientid" value="保 存" onclick="do_save_template_sort();" />
			</div>
	...
	<fieldset  class="fieldsetstyle">
            ...
            <div class="rightdiv sublink" style="padding-right:20px;">
			<input name="editsortid" type="button" class="button_1" id="editsortid" value="保 存" onclick="do_save_edit_template_sort();" />
			<input name="delsortid" type="button" class="button_3" id="delsortid" value="删 除" onclick="do_delete_template_sort();" />
			</div>
