...
?>
    ...
    <style type="text/css" >
        ...
        #data_CompanyArea,#data_CompanyIndustry,#data_CompanyArea2{
                            ...
                            <fieldset  class="fieldsetstyle">
                                ...
                                <table width="98%" border="0" cellpadding="4" cellspacing="1" bgcolor="#FFFFFF" class="inputstyle">
                                    ...
                                    <tr>
                                        ...
                                        <td width="55%"><label>
                                                <select name="data_CompanyArea2" id="data_CompanyArea2"  class="select2" style="*display:block !important;" onchange='changecity(this.options[this.options.selectedIndex].value);'>
                                    ...
                                    <tr>
                                      ...
                                      <td><select name="data_CompanyArea" id="data_CompanyArea" class="select3" style="*display:block!important;" >
                ...
                <script type="text/javascript">
                    function do_edit_company()
                    {
                        ...
                        else if($('#data_CompanyIndustry').val()=="" || $('#data_CompanyIndustry').val()=="0")
                        {
                            ...
                            $.post("do_system.php?m=content_edit_alimerchant_save",$("#MainForm").serialize(),
                                function(data){
                                    data = $.trim(data);
                                    if(data == "ok"){
