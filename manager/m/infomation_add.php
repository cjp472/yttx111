    	...
    	<div class="lineblank"></div>
         ...
         <input type="hidden" name="set_filename" id="set_filename" value="" />
		   ...
		   <div id="searchline">
			...
			<input name="saveclientid" type="button" class="button_1" id="saveclientid" value="保 存" onclick="going('save','0')" />
		...
		<legend>基本资料</legend>
              <table width="98%" border="0" cellpadding="4" cellspacing="1" bgcolor="#FFFFFF" class="inputstyle">
                ...
                <tr>
                  ...
                  <td width="55%" bgcolor="#FFFFFF"><label>
                    <input type="text" name="data_ArticleTitle" id="data_ArticleTitle" />
                    <span class="red">*</span></label></td>
                  <td width="29%" bgcolor="#FFFFFF"><input type="text" name="data_ArticleColor" id="data_ArticleColor" title="标题颜色" style="width:100px;" />&nbsp;(标题颜色)</td>
                </tr>
                <tr>
                  <td bgcolor="#F0F0F0"><div align="right">作者：</div></td>
                  <td bgcolor="#FFFFFF"><input type="text" name="data_ArticleAuthor" id="data_ArticleAuthor" /></td>
                  <td bgcolor="#FFFFFF">&nbsp;</td>
                </tr>

                <tr>
                  <td bgcolor="#F0F0F0"><div align="right">文件：</div></td>
                  <td bgcolor="#FFFFFF"><input type="text" name="data_ArticlePicture" id="data_ArticlePicture" style="width:78%;" />&nbsp;<input name="bt_Picture" type="button" class="bluebtn"  onClick="upload_file('data_ArticlePicture');" value="上 传" title="上传" style="width:52px; height:25px; font-size:12px;" /></td>
                  <td bgcolor="#FFFFFF" id="data_ArticlePicture_text" title="文件">&nbsp;</td>
                </tr>
                <tr>
                  <td bgcolor="#F0F0F0"><div align="right">文件名称：</div></td>
                  <td bgcolor="#FFFFFF"><input type="text" name="data_ArticleFileName" id="data_ArticleFileName" /></td>
                  <td bgcolor="#FFFFFF">&nbsp;</td>
                </tr>
              </table>
	</fieldset>
