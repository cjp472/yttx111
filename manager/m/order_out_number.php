...
$InfoDataNum = $db->get_row("SELECT count(*) AS allrow FROM ".DATATABLE."_order_orderinfo where OrderCompany = ".$_SESSION['uinfo']['ucompany']."");
				...
				<tr>
				 ...
				 ?>
				   <tr>
					...
					<td >【<a href="order_all_out_excel.php?ty=all&b=<? echo $i;?>" target="_blank" > 导出数据</a>】 </td>
				   </tr>
				<? }?>			
              </table>			
              </form>
