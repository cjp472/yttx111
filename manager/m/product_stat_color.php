		...
		<legend>商品订购颜色统计：</legend>
             <table width="100%" border="0" cellspacing="0" cellpadding="0">
				 ...
				 <?
					...
					$statsql  = "SELECT sum(c.ContentNumber) as cnum,c.OrderID,c.ContentID,c.ContentName,c.ContentColor as ContentCS
                                 ...
                                 group by c.ContentColor ";
					$statdata = $db->get_results($statsql);


					$statsqlg  = "SELECT sum(c.ContentNumber) as cnum,c.OrderID,c.ContentID,c.ContentName,c.ContentColor as ContentCS
					...
					$statsqlr  = "SELECT sum(c.ContentNumber) as rnum,c.ContentID,c.ContentName,c.ContentColor as ContentCS
                                    ...
                                    and (o.ReturnStatus=2 or o.ReturnStatus=3 or o.ReturnStatus=5)
                                    group by c.ContentColor";
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
				chart = new Highcharts.Chart({
     			 ...
     			 <tr>
       				 <td height="30" bgcolor="#efefef" >&nbsp;&nbsp;&nbsp;&nbsp; <strong>（<? echo $productinfo['Name'];?>） 订购数据 - 颜色</strong></td>
     			 </tr>
     			 <tr>
       				 <td >
