...
$cartdata = $db->get_results("select c.*,i.Coding,i.Units,i.Casing,b.BrandName from ".DATATABLE."_order_cart c left join ".DATATABLE."_order_content_index i on c.ContentID=i.ID LEFT JOIN rsung_order_brand AS b ON i.BrandID=b.BrandID where c.CompanyID=".$_SESSION['uinfo']['ucompany']." and i.CompanyID=".$_SESSION['uinfo']['ucompany']." and c.OrderID=".$oinfo['OrderID']." order by i.SiteID asc,c.ID asc");
        ...
        <div class="bline">
			...
			<form id="MainForm" name="MainForm" method="post" action="" target="exe_iframe" >
				...
				<div class="border_line">
					<div class="line font14">订单号：<span class="font14h"><? echo $oinfo['OrderSN'];?></span> <input name="order_id" id="order_id" type="hidden" value="<? echo $oinfo['OrderID'];?>"  />&nbsp;&nbsp;&nbsp;&nbsp;   状态：<span class="font14h"><? echo $order_status_arr[$oinfo['OrderStatus']];?></span></div>
				</div>				
...
<td  height="30" width="70" align="center" style="border-bottom:#cccccc solid 1px;">
  ...
  <tr><td height="28">&nbsp;</td><td class="font12">&nbsp;合计：</td><td>&nbsp;</td><td>&nbsp;</td>
	...
	<td  >&nbsp;</td>
	<? }?>
	<td class="font12">&nbsp;<? echo $allnumber;?></td><td  >&nbsp;</td><td class="font12">¥ <? echo $alltotal2;?></td><td>&nbsp;</td><td class="font12">¥ <? echo $alltotal;?></td><td>&nbsp;</td></tr>
   </tbody>
</table>
			
			<div class="line22" align="right">
			<!--
			<input type="button" value="继续订购商品" class="bluebtn" name="confirmbtn" id="confirmbtn" onclick="javascript:window.location.href='order_add_product.php?oid=<? echo $oinfo['OrderID'];?>'" />&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="保存修改" class="redbtn" name="confirmbtn" id="confirmbtn" onclick="do_save_order_product('reload',0)" />
			-->
			&nbsp;&nbsp;&nbsp;&nbsp;
