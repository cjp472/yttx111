              ...
              <table width="98%" border="0" cellpadding="4" cellspacing="1" bgcolor="#FFFFFF" class="inputstyle">
                 <tr>
                  ...
                  <td width="55%" bgcolor="#FFFFFF"><label>
                    <select name="data_OrderUserID" id="data_OrderUserID" class="select2" style="width:564px;" onChange="javascript: get_addlist(this.options[this.selectedIndex].value);"  >
                ...
                <tr>
				  ...
				  <div style="width:550px; height:250px; overflow:scroll;" id="showuseraddress">
