    ...
    <div id="bodycontent">
		...
		<div id="searchline">
        	...
        	<div class="rightdiv">
        	 ...
        	 <div class="location"><a name="editname"></a><strong>&nbsp;&nbsp;当前位置：</strong><a href="infomation.php">信息管理</a>  &#8250;&#8250;<a href="sort.php">栏目管理</a> </div>
...
<strong><span class="iconfont icon-suoyouleibie" style="color:#33a676;font-size:14px;"></span>&nbsp;&nbsp;信息栏目</strong></div>

<ul>

	<?

	$sinfo = $db->get_results("SELECT SortID,SortName,SortOrder FROM ".DATATABLE."_order_sort where SortCompany=".$_SESSION['uinfo']['ucompany']." order by SortOrder DESC,SortID ASC");
...
<!-- tree -->   
			...
			<legend>新增栏目</legend>       
              ...
              <table width="92%" border="0" cellpadding="4" cellspacing="1" bgcolor="#FFFFFF" class="inputstyle">            
                ...
                <tr>
                  ...
                  <td width="16%" bgcolor="#F0F0F0"><div align="right">栏目名称：</div></td>
		...
		<fieldset title="content" class="fieldsetstyle">
            ...
            <div class="rightdiv sublink" style="padding-right:20px;">
			<input name="editclientid" type="button" class="button_1" id="editclientid" value="保 存" onclick="do_save_edit_sort();" />
			<input name="delclientid" type="button" class="button_3" id="delclientid" value="删 除" onclick="do_delete_sort();" />
			</div>
