...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" >
  ...
  <tr>
   ...
   <?php 
	...
	$bottommsg = '  <tr>
    <td colspan="'.(count($tdfield)).'"><strong>收货公司：</strong>'.$cinfo['InceptCompany'].'&nbsp;&nbsp;&nbsp;&nbsp;<strong>联系人：</strong> '.$cinfo['InceptMan'].'&nbsp;&nbsp;&nbsp;&nbsp;<strong>电话：</strong>'.$cinfo['InceptPhone'].'&nbsp;&nbsp;&nbsp;&nbsp;<strong>地址：</strong>'.$cinfo['InceptAddress'].'</td>
  </tr>';
