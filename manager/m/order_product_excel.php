...
if(empty($in['selectedID']))
{
	...
	$datasql   = "SELECT Name,Coding,Casing,Barcode,Units,OrderID,ClientID,ContentColor,ContentSpecification,ContentPrice,ContentNumber,ContentPercent,ContentSend FROM ".DATATABLE."_view_index_cart where CompanyID = ".$_SESSION['uinfo']['ucompany']."  and ID IN (".$idmsg.") order by SiteID asc, BrandID asc, ID asc limit 0,50";
