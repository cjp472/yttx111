...
<body>     
    <div id="bodycontent">
    	...
    	<div id="searchline">
        	<div class="leftdiv">
        	  <form id="FormSearch" name="FormSearch" method="post" action="new_order_add_product.php">
			...
			<div class="location"><strong>当前位置：</strong><a href="order.php">订单管理</a> &#8250;&#8250; <a href="order_product_edit.php?ID=<? echo $in['oid'];?>">订单商品管理</a> &#8250;&#8250; <a href="#">添加商品到订单</a></div> 
        </div>
        	  ...
        	  <table width="100%" border="0" cellspacing="0" cellpadding="0">               
               <thead>
                <tr>
				  ...
				  <!-- <td width="18%" class="bottomlinebold">&nbsp;生产厂家</td> -->
				  <!-- <td width="12%" class="bottomlinebold">&nbsp;规格</td> -->
				  <td width="18%" class="bottomlinebold">&nbsp;品牌</td>
				  <td width="12%" class="bottomlinebold">&nbsp;型号</td>
				  <td width="10%" class="bottomlinebold" align="right">单价(元)</td>
				  <td width="5%" class="bottomlinebold" align="right">单位</td>
                  <td width="15%" class="bottomlinebold" align="right">包装</td>                                    
...
?>
                <tr id="line_<? echo $lsv['ID'];?>" class="bottomline" onmouseover="inStyle(this)"  onmouseout="outStyle(this)">
				  ...
				  <td >&nbsp;<? echo $brandsqlarr[$lsv['BrandID']]['BrandName'];?></td>
