...
$in  = $inv->_htmlentities($in);
	...
	$total_fee    = $_GET['total_fee'];	    //获取总价格
		...
		$cinfo = $db->get_row("select PayID,PayCompany,PaySN,PayStatus from ".DATABASEU.DATATABLE."_order_alipay where PaySN = '".$out_trade_no."' order by PayID desc limit 0,1");
