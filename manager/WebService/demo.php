 ...
 * 序列号,请通过亿美销售人员获取
 */
$serialNumber = '0SDK-EMY-0130-KCRRO';
...
function setMOForward()
{
	...
	/**
	 * 向 15901511534 进行转发短信
	 */	
	$statusCode = $client->setMOForward('15901511534');
	echo "处理状态码:".$statusCode;
}
...
function sendSMS()
{
	global $client;
	/**
	 * 下面的代码将发送内容为 test 给 15901511534 和 15901511535
	 * $client->sendSMS还有更多可用参数，请参考 Client.php
	 */
	$statusCode = $client->sendSMS(array('15901511534','15901511535'),"test测试2");
	echo "处理状态码:".$statusCode;
}
...
function setMOForwardEx()
{
	...
	$statusCode = $client->setMOForwardEx(
		array('15901511534','15901511536','15901511535')
	);
	echo "处理状态码:".$statusCode;
}
