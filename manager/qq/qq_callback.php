...
if($rdata['ret'] != "0" || !empty($rdata['ret'])) exit('请关闭重新打开！');
...
<title>订货宝管理端 QQ帐号登录</title>
<meta name="keywords" content="订货宝 DHB.HK 订货管理系统 订单管理系统 在线订单管理系统 在线订货系统  网上订货系统 网络订货系统 网上订货平台 在线订货平台 订货软件 分销系统 在线软件 商品批发 " />
<meta name="Contact" content="support@rsung.com" />
<script src="../scripts/jquery.min.js" type="text/javascript"></script>
<script src="../m/js/login.js?v=0116" type="text/javascript"></script>
<style>
...
.inputline{width:98%; margin:4px;line-height:200%; height:auto; padding:8px 2px; clear:both;}
...
立即输入订货宝帐号密码，便可与QQ帐号绑定，以后就可以直接登录订货宝了！</div>
		</div>

		<div class="inputline">
			<div class="inputline_dt">订货宝帐号：</div><div class="inputline_dd"><label><input type="text" value="" name="bname" id="bname" class="inputs" /></label></div>
		</div>
		<div class="inputline">
			<div class="inputline_dt">订货宝密码：</div><div class="inputline_dd"><label><input type="password" value="" name="bpass" id="bpass" class="inputs" /></label></div>
		</div>
		<div class="inputline">
		...
		<div class="inputline" align="center" style="height:38px; margin-top:10px;">
		...
		<div class="inputline tiptext" >
			<font color=red>提示：</font><br />将订货宝帐号与QQ帐号绑定之后，便可通过已登录QQ直接点击进入，无需再登录！
		</div>
