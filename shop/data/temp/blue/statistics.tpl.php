...
<div id="main">
<div id="location">当前位置： <a href="home.php">首页</a> / <a href="statistics.php">订单统计</a></div>
<div class="main_left">
<div class="fenlei_bg_tit"><span class="iconfont icon-wenjian" style="font-size: 15;color: white;margin-left: 10px"></span>   数据统计</div>
  <div class="news_info">
  <ul>
...
title: {
text: '从 <?=$in['begindate']?> 到 <?=$in['enddate']?> 订单数据'
},
subtitle: {
text: ''
},
