...
<div id="main">
<div id="location">当前位置： <a href="home.php">首页</a> / <a href="statistics.php">订单统计</a> / <a href="#">年订单统计</a></div>
<div class="main_left">
...
<dd><a href="statistics.php?m=year" ><strong><span class="ali-small-sanjiao iconfont icon-icon-copy-copy1"></span>年订单统计</strong></a></dd>
...
<form id="MainForm" name="MainForm" method="post" action="statistics.php"  >
             <table width="98%" align="center" border="0" cellspacing="0" cellpadding="0">
     			 <tr>
       				<td height="30" >&nbsp;<strong>年份：</strong>&nbsp;
       				<select name="y" id="y" style="border:1px solid #ABADB3;height:22px;line-height:20px;width: 70px">
<? if(is_array($ylist)) { foreach($ylist as $ykey => $yvar) { if($in['y']==$yvar) { ?>
<option style="margin-left: 5px" value="<?=$yvar?>" selected="selected">&nbsp;&nbsp;<?=$yvar?></option>
<? } else { ?>
<option style="margin-left: 5px" value="<?=$yvar?>">&nbsp;&nbsp;<?=$yvar?></option>
<? } } } ?>
