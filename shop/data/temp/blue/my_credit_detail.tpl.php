...
<p>
<span>开始时间：</span>
<input name="begindate" style="border: 1px solid #ABADB3;height: 20px;"type="text" id="begindate"   maxlength="12" onfocus="this.select();" value="
<? if($in['type'] == 'Upmonth') { ?>
<?=$lastFirst?>
<? } else { ?>
<?=$in['begindate']?>
...
<p>
<span>结束时间：</span>
<input name="enddate" style="border: 1px solid #ABADB3;height: 20px;"type="text" id="enddate" maxlength="12" onfocus="this.select();" value="
<? if($in['type'] == 'Upmonth') { ?>
<?=$lastEnd?>
<? } else { ?>
<?=$in['enddate']?>
...
<span><a id="seven-days" 
<? if(($in['timeselect'] == 'seven')) { ?>
style="color:#01A157;font-weight:;"
<? } ?>
>7天</a></span>
<span><a id="current-month" 
<? if(($in['timeselect'] == 'month')) { ?>
style="color:#01A157;font-weight:;"
<? } ?>
>本月</a></span>	
...
<? if(is_array($detailAdd['list'])) { foreach($detailAdd['list'] as $k => $v) { ?>
<tr>
