...
<div class="list_line">		
<div class="reset">
<p class="reset_title">设置医统账期支付密码</p>
<ul class="reset_con">
<li class="reset_tel">
<p>输入手机号：</p>
<input type="text" placeholder="请输入安全手机号,例：131****3212" id="credit_mobile" name="credit_mobile" maxlength="11"/>
</li>
<li class="reset_text">
<p>短信验证码：</p>
...
<input type="button" value="确认" class="reset_sure">
</div>
<br class="clear" />
</div>
<br />&nbsp;
