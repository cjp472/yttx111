...
<div id="main">
<div id="location">当前位置：<a href="home.php">首页</a> / <a href="infomation.php">信息</a> / <a href="infomation.php?sid=<?=$sortinfo['SortID']?>"><?=$sortinfo['SortName']?></a></div>
<div class="main_left">
...
<div class="list_line">
<? if(count($infomationtitle) > 1) { ?>
	
<div class="line">
<ol>
        
<? if(is_array($infomationtitle)) { foreach($infomationtitle as $tkey => $tvar) { ?>
            <li style="font-size:14px; line-height:200%; height:28px; padding:2px 0; list-style:none; margin:2px 0 2px 0; border-bottom:1px dotted #dbdbdb;"> <img src="./template/red/images/BLUE.png" class="img" />&nbsp; <a href="infomation.php?sid=<?=$tvar['ArticleSort']?>&ID=<?=$tvar['ArticleID']?>#locationname"><?=$tvar['ArticleTitle']?></a>
<? if(empty($sortinfo['SortID'])) { ?>
<span style="font-size:12px; padding-left:5px; color:#666">[<? echo date("Y-m-d",$tvar['ArticleDate']); ?>]</span>
<? } ?>
</li>
