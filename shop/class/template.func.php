...
{
	$tpldirmsg = str_replace("/", "_", $tpldir);
	$tpldirfile = str_replace("+", "/", $file);
	$tplfile = CONF_PATH_TPL."/".$tpldirfile.".html";
	$objfile = CONF_PATH_COMPILE."/".$tpldirmsg."".$tpldirfile.".tpl.php";

	if(@filemtime($tplfile) > @filemtime($objfile))
	{
		parse_template($tpldirfile,$tpldir);
	}
