...
if(empty($in['resultCode']) || empty($in['orderNo']) || isset($in['creatResult']) || $security->getSecurityMd5('yijifu', $logMsg)){
...
$resultCode = '';
if($in['service'] == 'qftIntegratedPayment' && (($in['resultCode'] == 'PAY_SUCCESS')||($in['resultCode'] == 'EXECUTE_PROCESSING')||($in['resultCode'] == 'EXECUTE_SUCCESS'))){
	$resultCode = 'DHB_WAIT';
