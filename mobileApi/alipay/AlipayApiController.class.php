...
class AlipayApiController{
    ...
    */
	...
	function show_alipay($param,$acType)
	{
		...
		$sql_l  = "select AccountsID,AccountsNO, AccountsName, PayPartnerID,PayKey from ".$param['Database'].DATATABLE."_order_accounts where AccountsCompany = ".$param['CompanyID']."  and PayType='alipay' and AliPhone='T' and AccountsID=".$acType." limit 0,1 ";    
